...
if (isset($_POST['adicionar'])) {
    ...
    $alteraUtilizador = mysqli_query($conn, "INSERT INTO utilizadores(nomeUtilizador, password, email, telemovel, tipo) values
    ...
    <div class="container-fluid bg-light pt-5">
        <div class="container py-5 px-4 px-sm-5">
            <div class="d-flex flex-column text-center">
                <h1 class="display-4 m-0"><span class="text-primary">Adicionar Utilizador</span> </h1>
            </div>
