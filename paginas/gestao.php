    ...
    <div class="container-fluid bg-light pt-5">
        <div class="container">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="reservas-tab" data-bs-toggle="tab" data-bs-target="#reservas" type="button" role="tab" aria-controls="reservas-tab" aria-selected="false">Gerir Reservas</button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row"><?php echo $utilizadoresInfo['id']?>  </td>
                                <td scope="row"><?php echo $utilizadoresInfo['nome']?>  </td>
                                <td scope="row"><?php echo $utilizadoresInfo['email']?>  </td>
                                <td scope="row"><?php echo $utilizadoresInfo['telemovel']?>  </td>
                                <td scope="row"><?php echo $utilizadoresInfo['tipo']?>  </td>
                                <td scope="row"> <a type="button" class="btn btn-primary" href="editarutilizador.php?id=<?php echo $utilizadoresInfo['id'];?>">Editar</a> </td>
                                <td scope="row"> <a type="button" class="btn btn-primary" href="eliminarutilizador.php?id=<?php echo $utilizadoresInfo['id'];?>">Eliminar</a> </td>
